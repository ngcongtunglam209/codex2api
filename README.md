...
<tr><td><b>Three account platforms</b></td><td>Codex, Grok, and Claude Code (Anthropic OAuth) subscriptions share one pool and one scheduler. Claude accounts are added by OAuth from the dashboard or by importing <code>~/.claude/.credentials.json</code>, and serve the native <code>/v1/messages</code> route directly.</td></tr>
