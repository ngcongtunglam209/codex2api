...
func (db *DB) migrateSQLite(ctx context.Context) error {
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS system_settings (
				...
				public_home_page_enabled INTEGER DEFAULT 1,
				public_pricing_config TEXT DEFAULT '{}',
	...
	columns := []struct {
		...
		{"system_settings", "public_home_page_enabled", "INTEGER DEFAULT 1"},
		{"system_settings", "public_pricing_config", "TEXT DEFAULT '{}'"},
